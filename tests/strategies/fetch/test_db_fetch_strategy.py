...
def test_kwargs():
    return [
        {
            "id":1,
            "test_data":"This is the first test sentence."
        },
        {
            "id":2,
            "test_data":"This is the second test sentence."
         }
    ]
...
def test_db_fetch_strategy_success(temp_address:str, test_kwargs:list, test_source:None):
